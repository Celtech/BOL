...
function CreateBaseMenu()
    ...
    LulzMenu:addParam("Skins", 'Skin Changer', SCRIPT_PARAM_LIST, 1,{"Classic", "High Noon", "Project ", "Blood Moon", "Amethyst", "Obsidian", "Jasper", "Emerald"})
...
function ItemsAndSummoners:__init()
    ...
    LulzMenu.Spell:addSubMenu("Summoner Spells LulzMenu", "SummonerSpellsMenu")
    LulzMenu.Spell:addSubMenu("Masteries LulzMenu", "MasteriesMenu")
...
function Prediction:ActivePrediction()
    ...
    if _G[_G.predictonTable.ActivePrediction] and _G.predictonTable.ActivePrediction ~= "FHPrediction" and self.lastPrediction ~= _G.predictonTable.ActivePrediction then
        ...
        activePrediction = _G[_G.predictonTable.ActivePrediction]()
