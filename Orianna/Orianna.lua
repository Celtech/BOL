...
function CheckUpdatesLib()
    ...
    ToUpdate.CallbackNoUpdate = function(OldVersion) print("<font color='#55AAAA'>[Lulzlib]</font> <font color='#FFFFFF'>".."No Updates Found, loading latest version</font>") UPDATED = true  end
